"""
Django settings for echomoodBackend project.
...
SECRET_KEY = 'django-insecure-%v0_b&!!82dv%+95gorfmhcr(572b!=h9#cilyl11m=0dkxd+c'
...
ROOT_URLCONF = 'echomoodBackend.urls'
...
WSGI_APPLICATION = 'echomoodBackend.wsgi.application'
